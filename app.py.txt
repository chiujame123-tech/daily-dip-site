...
def generate_dashboard():
        ...
        for t in tickers:
            try:
                ...
                if signal == "LONG":
                    ...
                    ai_text = "<b>⏳ Neutral:</b> Price in Premium. Wait."
    ...
    <body>
    <div style="text-align:center; margin-bottom:20px; color:#94a3b8; font-size:0.8rem;">Last Updated: {datetime.now().strftime('%Y-%m-%d %H:%M')}</div>
    <div class="tabs">
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=port)# app.py (最終完整版)
import matplotlib
matplotlib.use('Agg')  # 修正 1: 設定無圖形介面模式 (防止 Server 崩潰)
